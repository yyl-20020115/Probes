...
namespace Probes
{
    ...
    public abstract partial class MeasurementBaseBTControl : UserControl, IMeasurementBTControl
    {
        ...
        protected virtual int ReadTimeOut => SerialPort.InfiniteTimeout;
        protected virtual int WriteTimeOut => 1;
        protected virtual int WriteBufferSize => 2;
        protected virtual bool UseComEvents => true;
        ...
        protected virtual double SampleInterval { get; set; } = 1.0;
        ...
        protected virtual void SyncPlot(double Y)
        {
            var dt = (DateTime.Now - this.StartTime).TotalSeconds;
            this.SyncPlot(dt, Y);
        }
