...
#define PRESET_ZEROLEVEL  8482827
#define PRESET_100GLEVEL  8558457
#define PRESET_500GLEVEL  8860429
...
void HX711_Calibrate(int32_t rc)
{	
	int i = 0;
	int Values = 0;
	int Delta = 0;
	for(i = 0;i<N;i++)
	{
		Values += HX711_GetMiddleFilterValue(HX711_Read());
	}
